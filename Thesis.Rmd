...
**Table 3:**Mean component scores of PCA on intra-specific habitat selection within cottonmouths with ANOVAs used to compare groups
...
plot_grid(w1, x1,z1,y1, labels=c("A)", "B)", "C)","D)"), ncol = 2, nrow = 2)
```
