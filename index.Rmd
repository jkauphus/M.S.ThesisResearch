...
ggplot() + geom_polygon(data = state, aes(x=long, y = lat, group = group),
  ...
  xlab("Longitude") + ylab("Latitude") + ggtitle("Study Site, Cheatham Co., TN")

```
Map 1: The location of the study site along a swamp adjacent to The Cumberland River Bicentennial Trail, Cheatham County, TN, USA.
```{r Study Site}
#Shapefiles
...
tm_shape(Boundary)+
  ...
  tm_dots(col = "yellow", size = 0.05, id = "NAME", text = "Cottonmouth location")+
  tm_scale_bar()+
...
a
```
Map 2: The study area along the Cumberland River Bicentennial Trail, Cheatham County, TN. The boundary line where collection takes place is colored in red, and the cottonmouth locations were symbolized as yellow points. 
