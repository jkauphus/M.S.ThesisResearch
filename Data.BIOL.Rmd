...
<p style= "color:red">We had three main question:

1:What are the habitat preferences of the cottonmouth?

2:Are their intra-specific differences among the cottonmouths?

3:Can you consider the cottonmouth a to be generalist species in regards to habitat selection?

**We tested the hypothesis that cottonmouths shift in habitat selection ontogenetically, and this document is to briefly summarize those initial findings.** </p> 
...
```{r PERMANOVA & PERMDISP Tests, fig.height=4, fig.width=8}
#PERMANOVA
...
```{r Linear Regression, fig.height=6, fig.width=14}
#Linear Regression
